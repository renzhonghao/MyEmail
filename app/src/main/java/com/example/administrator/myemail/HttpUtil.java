...
import com.example.administrator.myemail.MyApplication;
import com.example.administrator.myemail.Attachment;
import com.example.administrator.myemail.MailInfo;
import com.example.administrator.myemail.MyAuthenticator;
...
//			mdp.setContent(mailContent, "text/html;charset=gb2312");//给BodyPart对象设置内容和格式/编码方式
			mdp.setContent(mailContent,"text/html;charset=utf-8");//给BodyPart对象设置内容和格式/编码方式tcontent为邮件内容
//			mdp.setText("你是");
